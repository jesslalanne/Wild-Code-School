/*
* Consigne : créer une fonction qui teste si un carré est un carré latin.
* Particularité : la taille du carré latin n'est pas précisée !
* Il faut donc prévoir une fonction qui teste
...
function testCarreLatin(carre){
    ...
    for (i = 0; i < carre.length; ++i) {
        ...
        let comptage_occurences_ligne = countOccurences(carre[i]);
        for (let k in comptage_occurences_ligne){
